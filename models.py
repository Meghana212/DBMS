...
class Route(models.Model):
    ...
    source_airport = models.ForeignKey(Airport, models.DO_NOTHING, db_column='Source_Airport', blank=True, null=True)  # Field name made lowercase.
    destination_airport = models.ForeignKey(Airport, models.DO_NOTHING, db_column='Destination_Airport', blank=True, null=True)  # Field name made lowercase.
